...
<html>
	...
	<body>
		<div id="page">
			<div id="header">
			  <a href="index.html" id="logo"><img src="images/C2.jpg" alt="" width="232" height="104"></a>
			  <ul id="navigation">
				<li class="first"><a href="Home.jsp">Home</a></li>
					...
					<li><a href="ViewHistory.jsp">Order History</a></li>
					  ...
					  <div class="first">
							<div>
							  <div class="first">
								    ...
								    <p><a href="AddProduct.jsp">ADD PRODUCTS</a>
								    <font color="red">
								    <% 
								...
								<p><a href="ViewProductFUpdateDelete.jsp">Update / Delete PRODUCTS </a></p>
							
								<p><a href="ViewCustomerRegister.jsp">View All Customer Registerd</a></p>
								<p><a href="CurrentOrder.jsp">view the current order placed by customer with payment details</a></p>
								<p><a href="ViewOrder.jsp">the order and change status of all pending orders</a></p>
						    </div>
							</div>
					  </div>
